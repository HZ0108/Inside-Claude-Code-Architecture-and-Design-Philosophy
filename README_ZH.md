...
- [Inside Claude Code：架构与设计哲学](#inside-claude-code架构与设计哲学)
  ...
  - [核心架构支柱](#核心架构支柱)
    - [1. 综合分析总览](#1-综合分析总览)
    - [2. 上下文与 Token 管理](#2-上下文与-token-管理)
    - [3. 多层记忆系统](#3-多层记忆系统)
    - [4. Agent 算法与工具编排](#4-agent-算法与工具编排)
    - [5. 上下文动态注入](#5-上下文动态注入)
    - [6. Query 可靠性机制](#6-query-可靠性机制)
    - [7. Sub-Agent 系统](#7-sub-agent-系统)
    - [8. 工具系统](#8-工具系统)
    - [9. Hook 系统](#9-hook-系统)
    - [10. 意图路由](#10-意图路由)
  - [文档目录](#文档目录)
...
从全局视角纵览整个 Claude Code 系统——将九大架构支柱串联为一条完整的叙事线。对于希望先理解全局再深入各子系统的读者，本文档是推荐的入口。

📄 **完整报告：** [总览：综合分析.pdf](./ZH/总览：综合分析.pdf)
...
| # | 主题 | English | 中文 |
|---|------|---------|------|
| 1 | 综合分析总览 | [Overview: Comprehensive Analysis.pdf](./EN/Overview:%20Comprehensive%20Analysis.pdf) | [总览：综合分析.pdf](./ZH/总览：综合分析.pdf) |
| 2 | 上下文与 Token 管理 | [EN/Context Management.pdf](./EN/Context%20Management.pdf) | [上下文管理.pdf](./ZH/上下文管理.pdf) |
| 3 | 多层记忆系统 | [EN/Memory System.pdf](./EN/Memory%20System.pdf) | [记忆系统.pdf](./ZH/记忆系统.pdf) |
| 4 | Agent 算法与工具编排 | [EN/Agent Algorithm Flow.pdf](./EN/Agent%20Algorithm%20Flow.pdf) | [Agent算法流程.pdf](./ZH/Agent算法流程.pdf) |
| 5 | 上下文动态注入 | [EN/Context Dynamic Injection.pdf](./EN/Context%20Dynamic%20Injection.pdf) | [上下文动态注入方案.pdf](./ZH/上下文动态注入方案.pdf) |
| 6 | Query 可靠性机制 | [EN/Query Reliability Mechanism.pdf](./EN/Query%20Reliability%20Mechanism.pdf) | [query可靠性机制.pdf](./ZH/query可靠性机制.pdf) |
| 7 | Sub-Agent 系统 | [EN/Sub-Agent-System.pdf](./EN/Sub-Agent-System.pdf) | [sub-agent系统.pdf](./ZH/sub-agent系统.pdf) |
| 8 | 工具系统 | [EN/Tool System.pdf](./EN/Tool%20System.pdf) | [工具系统.pdf](./ZH/工具系统.pdf) |
| 9 | Hook 系统 | [EN/Hook System.pdf](./EN/Hook%20System.pdf) | [Hook系统.pdf](./ZH/Hook系统.pdf) |
| 10 | 意图路由 | [EN/Intent Routing.pdf](./EN/Intent%20Routing.pdf) | [意图路由.pdf](./ZH/意图路由.pdf) |
